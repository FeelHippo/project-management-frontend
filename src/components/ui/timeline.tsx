...
import type { TimelineColor } from '@/lib/interfaces/timeline';
    ...
    const content = (
      ...
      >
        ...
        <div className="flex flex-col justify-start pt-1">
          <TimelineTime className="text-right pr-8">{date}</TimelineTime>
        </div>
...
const TimelineIcon = ({
  ...
  return (
    <div
      className={cn(
        'relative flex items-center justify-center rounded-full ring-16 ring-background shadow-sm',
